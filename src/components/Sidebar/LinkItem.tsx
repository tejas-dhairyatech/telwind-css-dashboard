...
const LinkItem = ({ href, text, bedge, icon: Icon }: LinkProps) => {
    return (
        <>
            <li className="transform transition duration-300 hover:scale-105 active:scale-95 pointer:active:scale-100">
